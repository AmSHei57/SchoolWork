...
uname = "Amin" #Client username, used for reference 
...
def AudioFeatures(sp):
    tracks = sp.user_playlist_tracks(uname,"3dWSnJsb7ZkCYbq62WjyNQ",limit = 1)
    t_items = tracks.items()
    print(t_items)
    
def main():
    AudioFeatures(Authentication(cid,secret,uname,r_url))
